...
4. go into the "Masm615a" folder in the root directory through the command prompt
5. type "make32 yourAsmFileNameHere" into the cmd 
6. Run the program my typing "yourAsmFileNameHere" into the cmd
7. Tada!